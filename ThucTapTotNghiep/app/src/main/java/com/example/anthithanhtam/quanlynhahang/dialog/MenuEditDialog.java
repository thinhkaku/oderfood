...
public class MenuEditDialog extends BaseDialog {
    ...
    public static MenuEditDialog newInstace(Menu menu, Context context) {
        MenuEditDialog menuEditDialog = new MenuEditDialog(menu, context);
        menuEditDialog.setStyle(DialogFragment.STYLE_NORMAL,
                android.R.style.Theme_Light_NoTitleBar);
        return menuEditDialog;
    }

    public MenuEditDialog(Menu menu, Context context) {
        this.menu = menu;
